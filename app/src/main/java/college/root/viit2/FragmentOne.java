...
public class FragmentOne extends Fragment implements Animation.AnimationListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        animFadein = AnimationUtils.loadAnimation(getActivity(),
                R.anim.fadein);
        animFadein2 = AnimationUtils.loadAnimation(getActivity(),
                R.anim.fadein2);
        animFadein3 = AnimationUtils.loadAnimation(getActivity(),
                R.anim.fadein3);
        animFadein.setAnimationListener(this);
        imageView.startAnimation(animFadein);
        imageView1.startAnimation(animFadein2);
        imageView2.startAnimation(animFadein3);
